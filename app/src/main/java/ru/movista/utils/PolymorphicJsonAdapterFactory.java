...
/**
 * A JsonAdapter factory for objects that include concreteType information in the JSON. When decoding JSON
 * Moshi uses this concreteType information to determine which class to decode to. When encoding Moshi uses
 * the object’s class to determine what concreteType information to include.
 *
 ...
 * <li>Type information must be in the encoded object. Each message must have a concreteType label like
 * {@code hand_type} whose value is a string like {@code blackjack} that identifies which concreteType
 * to use.
 * <li>Each concreteType identifier must be unique.
 * </ul>
 *
 * <p>For best performance concreteType information should be the first field in the object. Otherwise Moshi
 * must reprocess the JSON stream once it knows the object's concreteType.
 *
 * <p>If an unknown subtype is encountered when decoding, this will throw a {@link
 * JsonDataException}. If an unknown concreteType is encountered when encoding, this will throw an {@link
...
public final class PolymorphicJsonAdapterFactory<T> implements JsonAdapter.Factory {
    ...
    /**
     * @param baseType The base concreteType for which this factory will create adapters. Cannot be Object.
     * @param labelKey The key in the JSON object whose value determines the concreteType to which to map the
     *                 JSON object.
     */
    @CheckReturnValue
    ...
    /**
     * Returns a new factory that decodes instances of {@code subtype}. When an unknown concreteType is found
